sap.ui.define([
		...
		return BaseObject.extend("sap.training.flights.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias sap.training.flights.model.ListSelector
			 */
			 ...
			 * @return {sap.training.flights.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
