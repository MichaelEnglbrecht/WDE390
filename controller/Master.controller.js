/*global history */
sap.ui.define([
		"sap/training/flights/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"sap/training/flights/model/formatter",
		"sap/training/flights/model/grouper",
		"sap/training/flights/model/GroupSortState"
	], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, grouper, GroupSortState) {
		"use strict";

		return BaseController.extend("sap.training.flights.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("sap.training.flights.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Seatsocc", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Seatsocc", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sConnId = mParams.firstListitem.getBindingContext().getProperty("Connid");
						var dateFormat = sap.ui.core.format.DateFormat.getDateInstance({pattern : "yyyy-MM-dd hh:mm" });  
						var fdat = dateFormat.format(new Date(Date.parse(mParams.firstListitem.getBindingContext().getProperty("Fldate"))));
			...
			_showDetail : function (oItem) {
				...
				jQuery.sap.require("sap.ui.core.format.DateFormat");  
				var dateFormat = sap.ui.core.format.DateFormat.getDateInstance({pattern : "yyyy-MM-dd hh:mm" });  
				var dateStr = dateFormat.format(new Date(Date.parse(oItem.getBindingContext().getProperty("Fldate")))); 
				console.log(dateStr);
				this.getRouter().navTo("object", {
