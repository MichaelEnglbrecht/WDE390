sap.ui.define([
	...
	return BaseObject.extend("sap.training.flights.model.GroupSortState", {
		 ...
		 * @alias sap.training.flights.model.GroupSortState
		 */
		...
		/**
		 * Sorts by Carrid, or by Seatsocc
		 *
		...
		/**
		 * Groups by Seatsocc, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "Seatsocc") {
				...
				this._oViewModel.setProperty("/sortBy", "Seatsocc");

				aSorters.push(
					new Sorter("Seatsocc", false,
